...
## Вывод
Лучшая модель для данной задачи это Классификатор дерева решений (DecisionTreeClassifier) так как скорость тут не в приоритете и точность наиболее высокая среди всех моделей. Accuracy наилучшей модели на валидационной выборке: 0.78
